...
const TRANSLATIONS = {
    'en': {
        ...
        'sortHint': 'Click to sort by this time - ascending, descending, then back to your order',
        'tags': 'Tags',  
        ...
        'aboutAlwaysOnTopDesc': 'On by default, so the list does not disappear behind your work. The pin at the top right turns it off and on; it is filled while the window is pinned',
    ...
    'ko': {
        ...
        'startTime': '시작 시간',
        'targetTime': '목표 시간',
        'sortHint': '누르면 이 시간으로 정렬합니다 - 오름차순, 내림차순, 그리고 원래 순서',
        'tags': '태그',
        'taskContent': '작업 내용',
        'status': '상태',
        // Tooltips
        ...
        'aboutAlwaysOnTopDesc': '기본으로 켜져 있어 목록이 하던 일 뒤로 사라지지 않는다. 오른쪽 위 핀으로 끄고 켠다. 고정돼 있는 동안 핀에 색이 차 있다',
    ...
    'zh': {
        ...
        'startTime': '开始时间',
        'targetTime': '目标时间',
        'sortHint': '点击可按此时间排序——升序、降序，再回到原顺序',
        'tags': '标签',
        'taskContent': '任务内容',
        'status': '状态',
        // Tooltips
        ...
        'aboutAlwaysOnTopDesc': '默认开启，使列表不会被其他窗口盖住。用右上角的图钉开关；置顶期间图钉是填充的',
    ...
    'ja': {
        ...
        'startTime': '開始時刻',
        'targetTime': '目標時刻',
        'sortHint': '押すとこの時刻で並べ替える - 昇順、降順、そして元の順',
        'tags': 'タグ',
        'taskContent': 'タスク内容',
        'status': 'ステータス',
        // Tooltips
        ...
        'aboutAlwaysOnTopDesc': '既定で有効。リストが作業の裏に消えない。右上のピンで切り替える。最前面の間はピンが塗られている',
    ...
    'es': {
        ...
        'sortHint': 'Pulse para ordenar por esta hora: ascendente, descendente y de vuelta',
        'tags': 'Etiquetas',
        ...
        'aboutAlwaysOnTopDesc': 'Activado de forma predeterminada, para que la lista no desaparezca detrás de su trabajo. La chincheta de arriba a la derecha lo activa y desactiva; se rellena mientras la ventana está fijada',
